...
import { installRendererFaultReporting } from "../../src/renderer/diagnostics";

function installBridge(): ReturnType<typeof vi.fn> {
	const report = vi.fn();
	Object.defineProperty(window, "bearDesktop", {
		value: { platform: "darwin", diagnostics: { reportRendererFault: report } },
		configurable: true,
	});
	return report;
}
