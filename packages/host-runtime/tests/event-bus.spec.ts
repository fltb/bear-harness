...
const representativePayloads: Record<KnownEventKind, unknown> = {
	...
	"artifact.created": { artifactId: "artifact-1", runId: "run-1" },
	"commission.drafted": { commissionId: "commission-1", draftHash: "hash" },
	"commission.approved": { commissionId: "commission-1", draftHash: "hash" },
	"commission.rejected": { commissionId: "commission-1" },
	"commission.status_changed": { commissionId: "commission-1", status: "queued" },
	"run.enqueued": {
		runId: "run-1",
		commissionId: "commission-1",
		executorProfile: "profile-1",
	},
