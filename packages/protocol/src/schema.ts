 ...
 * APIs); it depends only on TypeBox. Runtime consumers import it via
...
export const OnboardingStatus = Type.Union([Type.Literal("active"), Type.Literal("complete")], {
	additionalProperties: false,
});
...
export const OnboardingSubmitRequest = Type.Object(
	{
		stepId: Type.String({ minLength: 1, maxLength: 64, pattern: "^[a-z][a-z0-9_]*$" }),
		answer: Type.Optional(Type.String({ maxLength: MAX_STRING_LENGTH })),
	},
	{ additionalProperties: false },
);
export const OnboardingStateData = Type.Object(
	{
		...
		decisions: Type.Object(
			{
				relationship_kind: Type.Optional(
					Type.String({ minLength: 1, maxLength: 64, pattern: "^[a-z][a-z0-9_]*$" }),
				),
...
export const MessageCorrectRequest = Type.Object(
	{
		...
		applyScope: Type.Union(
			[Type.Literal("once"), Type.Literal("session"), Type.Literal("always")],
			{ additionalProperties: false },
		),
	},
	{ additionalProperties: false },
...
export const MemoryApprovalDecision = Type.Union(
	[Type.Literal("approve"), Type.Literal("approve_edited"), Type.Literal("reject")],
	{ additionalProperties: false },
);
...
export const VoiceStackSwitchRequest = Type.Object(
	{
		...
		scope: Type.Union([Type.Literal("next_scene"), Type.Literal("branch_only")], {
			additionalProperties: false,
		}),
...
export const CommissionDraftRequest = Type.Object(
	{
		...
		reads: Type.Optional(
			Type.Array(Type.String({ minLength: 1, maxLength: MAX_PATH_LENGTH }), { maxItems: 20 }),
		),
