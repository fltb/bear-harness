...
export const zhTW = {
	...
	"memory": {
		...
		"pinned": "置頂",
		"loading": "正在讀取…",
		"emptyEntries": "還沒有記住什麼。確認“最近想記住”裡的候選後，會出現在這裡。",
		"defaultEntriesTitle": "已記住",
		"fallbackConversation": "對話",
		"approved": "已記住",
		"rejected": "已拒絕",
		"saved": "已儲存",
		"approvedEdited": "已記住修改後的內容",
		"recentCandidates": "最近想記住",
		"candidatesNote": "敏感或不確定的內容會先放在這裡等你確認；明確的稱呼與普通偏好會自動記住。",
		"noCandidates": "沒有待確認的候選記憶。",
		"remember": "記住",
		"edit": "修改",
		"reject": "拒絕",
