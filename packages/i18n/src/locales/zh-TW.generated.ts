...
export const zhTW = {
	...
	"attachments": {
		...
		"downloading": "正在準備下載…",
		"readFailed": "無法讀取這個附件。",
		"previewUnavailable": "無法預覽這個檔案，但仍可下載。",
		"downloadFailed": "無法下載這個檔案，請重試。",
		"retry": "重試",
		"remove": "移除 {name}",
		"uploadStates": {
			"complete": "已就緒",
		...
		"imagePreview": "{name} 的圖片預覽",
		"audioPreview": "{name} 的音訊預覽",
		"videoPreview": "{name} 的影片預覽",
		"pdfPreview": "{name} 的 PDF 預覽",
		"pdfFallback": "瀏覽器無法顯示這份 PDF，可下載後檢視。"
	},
	"currentRolePackage": {
		"selectorLabel": "本地角色庫",
		"activeSuffix": " · 當前",
		...
		"projectionCounts": "變數 {variables} · 解鎖項 {unlockables}",
	...
	"messages": {
		...
		"memoryAlreadyKnown": "已經記住了",
		"memoryNotExtractable": "沒有發現可長期記住的內容",
		"memoryAlreadyProcessed": "這一刻已經處理過",
		"memoryCaptureDisabled": "長期記憶未開啟",
		"memoryPersistenceFailed": "儲存失敗，請重試",
	...
	"memory": {
		...
		"noSearchResults": "沒有找到匹配的記憶。請調整搜尋詞或範圍。",
