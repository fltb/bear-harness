...
export const en = {
	...
	relationshipMemory: {
		...
		profiles: "Scenes and profile",
		refresh: "Refresh memory",
		loading: "Reading this character’s memory…",
		...
		explicitDescription:
			"Content you explicitly asked to remember is stored separately from automatic relationship memory. Ask in the conversation to add, change, or forget it.",
		explicitEmpty: "No explicitly saved memory yet.",
	...
	currentRolePackage: {
		...
		promptEditorDescription:
			"Edit identity, voice and default context in the character package, without changing current story state or memory.",
		personaFields: {
			summary: "Character introduction",
			invariants: "Fixed principles",
			knowledge: "Knowledge boundaries",
			never: "Behavior boundaries",
			uncertain: "Handling uncertainty",
			interaction: "Voice and interaction",
		},
		listHint: "One item per line.",
		examplesTitle: "Dialogue examples",
		exampleRoles: { user: "User", assistant: "Character" },
		addExample: "Add example",
		removeExample: "Remove example",
		systemPromptTitle: "Character System Prompt",
		systemPromptHint:
	...
	threadHead: {
		...
		runningWork: "Current work",
		recentWork: "Recent tasks",
		noRunningWork: "No unfinished tasks. Conversation responses are shown in the thread.",
		runningWorkItem: "Task in progress",
	...
	messages: {
		...
		connectionUnavailable:
			"The app cannot reach its local service. A submitted request may already have been accepted; wait for reconnection to check its status.",
		connection: {
			connecting: "Connecting to the local service…",
			reconnecting: "Reconnecting… Conversation activity may be out of date.",
		},
		activity: {
			memory_recall: "Recalling relevant memories",
			context: "Preparing conversation context",
			memory_capture: "Model response ended · Processing conversation memory",
			responding: "Responding",
			tool: "Running a tool",
			retry: "Retrying the model request",
			retryAttempt: "Attempt {attempt} of {maxAttempts}",
			retryDelay: "Scheduled retry delay: {seconds} seconds",
			retryReason: "Retry reason:",
			compaction: "Compacting conversation context",
			memoryRecallFailed: "Memory recall failed:",
			memoryCaptureFailed: "Memory processing failed; this does not mean the response failed:",
			failed: "This stage did not complete:",
		},
		submission: {
			send: {
				label: "Message request · Local submission",
				submitting: "Submitting message… Not yet confirmed by the service.",
				accepted: "Message request accepted · Waiting for conversation sync.",
				failed: "Message request rejected. It was not accepted.",
				unknown:
					"Message request status unknown. It may have been accepted; check after reconnecting before retrying.",
			},
			edit: {
				label: "Edit and resend request",
				submitting: "Submitting edit and resend…",
				accepted: "Edit and resend accepted · Execution status is shown separately.",
				failed: "Edit and resend rejected. The revision was not accepted.",
				unknown:
					"Edit and resend status unknown. It may have been accepted. Refresh to inspect the conversation; this will not resubmit the edit.",
			},
			correct: {
				label: "Correction request",
				submitting: "Submitting correction…",
				accepted: "Correction accepted · Execution status is shown separately.",
				failed: "Correction rejected. The correction was not accepted.",
				unknown:
					"Correction status unknown. It may have been accepted. Refresh to inspect the conversation; this will not resubmit the correction.",
			},
			queue: {
				steering: "Queued guidance · Applies during the current response",
				followUp: "Queued follow-up · Runs after the current response",
			},
			dismiss: "Dismiss local request",
			refresh: "Refresh conversation status",
		},
		toolActivity: {
			externalResult: "External execution result received",
			stateRead: "Read character state",
			stateUpdate: "Update character state",
			skill: "Consult character skills",
			delegate: "Delegate external work",
			runRead: "Read execution record",
			media: "Show character media",
			choices: "Offer reply choices",
		...
		native: {
			...
			details: "Details",
			source: "Source",
			unsupported: "Unsupported native content; inspect the source below.",
			image: "Native image",
			blockedImage: "Image not loaded: only embedded raster images are displayed.",
			filteredHtml: "Raw HTML is not rendered. Inspect the source below.",
			thinking: "Reasoning",
			...
			noArguments: "Arguments unavailable in loaded history.",
			noResult: "No native output available.",
			truncatedOutput: "Native output was truncated.",
		...
		openMedia: "View",
		playMedia: "Play",
		expandMedia: "Expand viewer",
		restoreMedia: "Restore viewer",
		originalMediaSize: "Original size",
		fitMedia: "Fit to window",
		mediaUnavailable: "This media could not be loaded. Close the viewer and try again.",
		stopAmbientMedia: "Stop ambient media",
		stopMedia: "Stop ambient media",
		rememberMoment: "Remember this moment",
		responseStopped: "Response stopped by request. This is not a send failure.",
		responseFailedSaved:
			"The response did not finish. Your message is saved and you can request a correction.",
		justNow: "Just now",
		...
		retry: "Retry",
		editLabel: "Edit and resend message",
		save: "Resend edited message",
		cancel: "Cancel",
	...
	settings: {
		...
		diagnosticsEventLimit:
			"Up to 200 events per page. Download is segmented JSONL with events and complete payloads on each line.",
		diagnosticsHint:
			"Character-local traces; policy changes apply immediately to new records. System logs share the level and retention policy but never contain character content. Credentials are always filtered.",
		diagnosticsLevel: "Minimum log level",
		diagnosticsContent: "Payload recording",
		diagnosticsFull: "Full content",
		diagnosticsMetadata: "Metadata only",
		diagnosticsRetention:
			"Retention: {days} days / {mib} MiB per character; active traces are protected.",
		diagnosticsTemporary: "TRACE for 15 minutes",
		diagnosticsStopTemporary: "Stop temporary TRACE",
		diagnosticsHealth:
			"This runtime: {written} written · {queued} queued · {dropped} dropped · {failed} write failures",
		diagnosticsReveal: "Open this character's trace directory",
		diagnosticsRevealSystem: "Open system logs",
		diagnosticsRevealMemory: "Open this character's TDAI directory",
		diagnosticsRefresh: "Refresh",
		diagnosticsRecent: "Recent traces (100 per page)",
		diagnosticsEventFilter: "Event name (exact match)",
		diagnosticsConversationFilter: "Conversation ID",
		diagnosticsFirstPage: "First page",
		diagnosticsNextPage: "Next page",
		diagnosticsPin: "Keep this trace",
		diagnosticsIncidents: "Errors and incidents only",
		diagnosticsRevealLatest: "Open latest trace folder",
		diagnosticsUnpin: "Unpin trace",
		diagnosticsMetrics: "Performance metrics",
		diagnosticsExportWarning:
			"Includes private conversation and tool content. The download contains events and checksum-verified payloads. Review before sharing.",
		diagnosticsDownload: "Download trace with payloads",
		...
		visionModel: "Fallback image reader",
		visionModelHint:
			"Used by the image-reading Skill only when the current reply model does not support images.",
		visionModelNative: "The current reply model supports images directly; no fallback is needed.",
		visionModelAuto: "No fallback model",
		...
		oauthCallbackLabel: "Authorization callback link",
		...
		oauthCopyCode: "Copy",
		oauthCodeCopied: "Copied",
		oauthSubmit: "Continue sign-in",
		oauthManualSubmit: "Submit link",
	...
	work: {
		...
		deny: "Deny",
		stop: "Stop",
		steer: "Supplement instructions",
		steerInputLabel: "Supplementary instructions",
		steerPlaceholder: "Add guidance for this task…",
		interrupt: "Interrupt",
		resume: "Resume",
		download: "Save a copy",
		activity: {
			workspace: "Task execution",
			description: "Follow progress, address blockers, and receive results.",
			timeline: "Execution timeline",
			command: "Run command",
			read: "Read file",
			write: "Write file",
			tool: "Use tool",
			model: "Working out the next step",
			retry: "Automatic retry",
			retryEnd: "Retry finished",
			message: "Worker response",
			error: "Error encountered",
			paused: "Task paused",
			event: "Execution event",
			starting: "Submitted; waiting for the worker to start",
			updatedAt: "Last update",
			finishedAt: "Finished at",
			attempt: "Retry {attempt} of {total}",
			retryDelay: "Retrying in {seconds} seconds",
			recovered: "Recovered; execution continues.",
			retryFailed: "Retry did not recover. Check the final task status.",
			raw: "Technical details",
			latest: "Back to latest activity",
			older: "Viewing earlier records. Return to the latest activity to follow this run.",
			adjust: "Add or adjust task instructions",
			background: "Keep chatting. Results will return to the originating conversation.",
			status: {
				pending: "Pending",
		...
		task: {
			scope: "All conversations for this character",
			unfinished: "Unfinished",
			history: "Task history",
			noHistory: "No past tasks yet. New delegated tasks will appear here.",
			details: "Task details",
			back: "Back to current work",
			close: "Close current work",
			origin: "Source conversation",
			openOrigin: "Open source conversation",
			loading: "Loading task…",
			loadFailed: "Could not load task data",
			retry: "Retry",
			loadOlder: "Older tasks",
			olderEvidence: "Older execution evidence",
			previousPage: "Previous page",
			instruction: "Original instruction",
			inputs: "Declared inputs",
			noArtifacts:
				"No result files are available. Inspect the summary and execution evidence below.",
			deliveryPending: "Result not yet reported to the source conversation",
			delivered: "Result reported to the source conversation",
			retryDelivery: "Retry result delivery",
			requestAgain: "Request re-execution in source conversation",
			requestAgainMessage:
				"Please re-execute task {runId} using the original instruction and declared inputs. Review its evidence first, then delegate a new task if appropriate. Additional instruction: {instruction}",
			requestSent: "Re-execution request sent. No new task is confirmed yet.",
			busy: "Applying action…",
			controllerUnknown:
				"Execution controller is unconfirmed. Only supported actions are available.",
			controllerLost: "Execution controller connection is confirmed lost.",
			noActions: "No execution controls are currently supported.",
			lastActivity: "Last recorded activity",
			errors: "Errors",
			steerOutcomes: {
				injected: "Instructions injected into the current turn",
				startedNewTurn: "A new continuation turn started",
		...
		result: {
			...
			issues: {
				...
				unsupported: "Preview is not supported for this file. Download it to open it.",
