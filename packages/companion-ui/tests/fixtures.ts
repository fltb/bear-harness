...
export const THEMED_CHARACTER: CharacterDisplay = {
	...
	theme: {
		...
		tokens: {
			surface: "#18191b", surface_alt: "#212225", text: "#ecedee", text_muted: "#9ba1a6",
			accent: "#4ccce6", line: "#43484e", danger: "#ff9592", amber: "#ffc53d",
			surface_canvas: "#111113", surface_sidebar: "#18191b", surface_panel: "#212225",
			surface_control: "#272a2d", surface_subtle: "#2e3135", surface_message: "#272a2d",
			surface_message_user: "#0b3a48", surface_action: "#00a2c7", surface_success: "#0b2e2a",
			surface_warning: "#392c00", surface_danger: "#3b1219", surface_overlay: "rgba(17,17,19,.72)",
			text_strong: "#ecedee", text_soft: "#9ba1a6", text_on_action: "#07171c",
			text_on_message: "#ecedee", text_action: "#4ccce6", text_success: "#86ead4",
			text_warning: "#ffc53d", text_danger: "#ff9592", line_strong: "#5a6169",
			line_soft: "#43484e", focus_ring: "#4ccce6", scroll_thumb: "#5a6169",
			shadow_color: "rgba(0,10,13,.55)",
		},
