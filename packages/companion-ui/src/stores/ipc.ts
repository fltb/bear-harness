...
export type MemoryInvalidateRequest = Wire.MemoryInvalidateRequest;
export type MemorySearchRequest = Wire.MemorySearchRequest;
...
export type MemoryPinRequest = Wire.MemoryPinRequest;
