...
export type MessageRole = Wire.MessageRole;
export type MessageVersion = Wire.MessageVersion;
export type Message = Wire.Message;
...
export type MessageBranchResult = Wire.MessageBranchResponse;
export type MessageApplyScope = Wire.MessageCorrectRequest["applyScope"];
export type MemoryScope = Wire.MemoryScope;
export type MemoryCandidate = Wire.MemoryCandidate;
export type MemoryCandidateKind = MemoryCandidate["kind"];
export type MemoryCandidateStatus = MemoryCandidate["status"];
export type MemoryEntry = Wire.MemoryEntry;
export type MemoryDecision = Wire.MemoryApprovalDecision;
export type MemoryListData = Wire.MemoryListCandidatesResponse;
export type MemorySearchData = Wire.MemorySearchResponse;
export type ProviderInfo = Wire.ProviderInfo;
export type ProviderAuthType = ProviderInfo["authType"];
...
export type CharacterRuntimeState = Wire.CharacterRuntimeState;
