...
export type CompanionStateData = Wire.CompanionStateResponse;
export type CompanionStateChange = Wire.CompanionStateChange;
...
export type SystemModelDefaultsData = Wire.SystemModelDefaultsGetResponse;
...
export type RunListRequest = Wire.RunListRequest;
export type RunGetRequest = Wire.RunGetRequest;
export type RunGetResponse = Wire.RunGetResponse;
export type RunSteerResponse = Wire.RunSteerResponse;
export type ArtifactIdentity = Wire.ArtifactIdentity;
export type ArtifactReadRequest = Wire.ArtifactReadRequest;
export type ArtifactReadResponse = Wire.ArtifactReadResponse;
export type ArtifactActionResponse = Wire.ArtifactActionResponse;
