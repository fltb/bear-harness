...
const rootsByTable: Record<string, readonly string[]> = {
	...
	run_manifests: ["runs"],
	evidence: ["runs"],
	artifacts: ["attachments", "runs"],
	conversation_attachments: ["attachments", "conversation"],
	conversation_attachment_files: ["attachments"],
	pending_turns: ["conversation"],
	artifact_adoptions: ["attachments", "runs"],
	provider_accounts: ["providers", "providerLogin", "models", "settings"],
	configured_models: ["models", "providers"],
	conversation_model_selections: ["models", "conversation"],
...
const rootsByEventDomain: Record<string, readonly string[]> = {
	...
	webdev: ["audit"],
	evidence: ["runs"],
	artifact: ["attachments", "runs"],
	companion: ["snapshot", "conversation"],
	pi: ["conversation"],
	conversation: ["conversation", "conversations"],
	conversationAttachment: ["attachments"],
	character: ["snapshot", "characters", "character", "characterRuntime"],
