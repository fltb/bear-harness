...
if (
	!process.env.BEAR_E2E_API_KEY &&
	process.env.BEAR_E2E_USE_PI_CONFIG !== "1" &&
	process.env.BEAR_E2E_USE_CODEX_SESSION !== "1"
) {
	throw new Error(
		"BEAR_E2E_API_KEY, BEAR_E2E_USE_PI_CONFIG=1, or BEAR_E2E_USE_CODEX_SESSION=1 is required by the release gate",
	);
}
